...
public class FilterPanel extends JPanel {
	...
	private void initControls() {
		...
		control.add(targetLabel);
		control.add(radOn);
		control.add(radOff);
		control.add(profilLabel);
		control.add(cboProfiles);
		control.add(colorLabel);
		control.add(cboColors);
		control.add(btnSave);
		...
		sliders.add(panHueLo);
		sliders.add(panHueUp);
		sliders.add(panSatLo);
		sliders.add(panSatUp);
		sliders.add(panValLo);
		sliders.add(panValUp);
